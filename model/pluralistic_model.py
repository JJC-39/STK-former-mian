...
from . import base_function, external_function, Discriminator_net
from . import Generator_net
...
class Pluralistic(BaseModel):
    ...
    def __init__(self, opt):
        ...
        self.net_G = Generator_net.define_g(gpu_ids=opt.gpu_ids)    #paper use our

        # define the discriminator model
        self.net_D = Discriminator_net.define_d(gpu_ids=opt.gpu_ids)
